    ...
    return (
        <div className="twitterNews">
            ...
            <div className="twitterNews__body">
                ...
                {/* img */}
                <div className="twitterNews__description">
                    <img src={tempUrl} alt="coming soon ... " />
                    <div className="twitterNews__descriptionInfo">
                        <h4>Hong Kong Disneyland will close again after a surge in coronavirus cases</h4>
                        <p><img src={linkIcon} alt="link icon" />cnn.com</p>
                    </div>
                </div>
                <p className="twitterNews__time">
                    12:01pm - Jul 13,2020
                </p>
            </div>
            <div className="twitterNews__footer">

                <FavoriteBorderIcon />  <span className="twitterNews__like">1.1k</span>

                <img src={thunderIcon} alt="..." />
                See the latest COVID 19 information
            </div>
